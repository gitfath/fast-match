    ...
    return (
        <div style={{ display: 'flex', background: '#f0f2f5', minHeight: '100vh', flexDirection: isMobile ? 'column' : 'row' }}>
            ...
            <main style={{
                ...
                <h1 className="font-heading" style={{ fontSize: isMobile ? '1.8rem' : '2.2rem', marginBottom: '20px' }}>Journal des Sanctions</h1>
                <div style={{ background: 'white', padding: isMobile ? '30px 15px' : '40px', borderRadius: '20px', textAlign: 'center', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
                    ...
                    <p style={{ color: '#888', fontSize: isMobile ? '1rem' : '1.2rem' }}>L'historique global des sanctions appliquées sera listé ici.</p>
                </div>
            </main>
        </div>
    );
